...
DEMO_KNOWLEDGE = [
    {
        ...
        "content": (
            "Отвечай по-русски, тепло и уверенно, всегда на Вы и без фамильярности. Пиши короткими абзацами, без канцелярита. "
            "Главная задача: быстро понять запрос, назвать релевантную услугу, ответить по смыслу, а затем мягко перевести к записи без повторяющихся уточнений."
        ),
    },
    {
